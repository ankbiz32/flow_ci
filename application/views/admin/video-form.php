...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="ml-2 mb-2 text-dark"><?=isset($data)? '<i class="fa fa-edit"></i>':'+'?>&nbsp;&nbsp;<?=isset($data) ? 'Edit ' : 'Add '?>Video</h4>
            </div><!-- /.col -->
            <div class="col-sm-6 mb-2">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="<?=base_url('Admin/gallery')?>">Gallery</a></li>
                  <li class="breadcrumb-item active"><?=isset($data) ? 'Edit ' : 'Add '?>Video</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
            ...
            <div class=" my-2 col-lg-6 col-md-6 col-sm-8">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="url" id="img_src" name="img_src" class="form-control" value="<?=isset($data) ? $vid->img_src : ''?>" required>
                        </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
                ...
                <?php if(isset($data)){?>
                    <div class="my-2 col-lg-6 col-md-6 col-sm-6">
                        <iframe height="230" style="width:100%" src="<?=$vid->img_src?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
